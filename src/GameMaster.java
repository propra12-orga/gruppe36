...
public class GameMaster extends JFrame {
	private JButton startsingle = new JButton();
	private JButton startmulti = new JButton();
	...
	public GameMaster() {
		...
		startsingle.setText("Start Single Player");
		startsingle.setBounds(150, 120, 100, 20);
		...
		startmulti.setText("Multiplayer offline");
		startmulti.setBounds(150, 160, 100, 20);
		...
		passwort.setBounds(150, 200, 100, 20);
		...
		multiplayer.setText("Multiplayer online");
		multiplayer.setBounds(150, 240, 100, 20);
		multiplayer.setEnabled(false);

		this.lHintergrund.setIcon(this.iHintergrund);
		this.lHintergrund.setBounds(0, -20, 400, 400);

		this.getContentPane().add(startsingle);
		this.getContentPane().add(startmulti);
